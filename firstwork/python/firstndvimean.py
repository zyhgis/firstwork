...
# flagste01=['.tif']
#
# ndvilist=GetFileList("E:\\wangxc20160912\\fcndvidata",flagste01)
# # ndvilist=[] # 文件列表
# print ndvilist
# # ndvilist=[]
try:
...
def firstndvi(ndvilist,output,ignoredata,invalidata):
    print "start"
    try:
        A=Tiff()     #调用读写栅格类文件
        ndvi=[] #tif数据集列表
        ...
        print "fail"
firstndvi(inputdata[:-3],inputdata[-1],inputdata[-3],inputdata[-2])
